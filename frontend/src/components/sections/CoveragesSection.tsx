      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto">
            ...
            Venezuela con profesionalismo y detalle técnico.
          </p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-card-gap">
          ...
          <div className="group relative bg-white border border-outline-variant rounded-lg overflow-hidden flex flex-col h-[500px]">
            <div className="relative h-2/3 overflow-hidden">
              <div
                ...
                data-alt="A wide-angle, high-resolution shot of a vibrant football match in the Liga FUTVE, showing players in a tense struggle for ball possession in the midfield. The stadium is filled with passionate fans, and the afternoon sun casts long, dramatic shadows across the lush green pitch. The image is crisp and professional, capturing the movement and grit of the Venezuelan league in a corporate editorial style."
                style={{
                  backgroundImage:
                    "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCOOm-XrFBi1e-ZhaV3weBKTnajl3wCN0nyspvJgGUIvyMkZcqVkLQg3ue29VbLlCwhlbNgW59CnGUSpriLwZ1KBcxQ0i1PQ8A_5mUplnnXhbS-sQ1HjNxLnDn7XaRm4Mpr27mBQ4GKdOS00NY4pB-bNQHs5kVKyrOVQD-Hgnfh60Y6idfGshVAX6AsyRgcYjlCpFTTPybNL4HoigRNlmkn8XK-aecrXEsv8rHlojywfoiw6hB0pqtRUA')",
                }}
              ></div>
          ...
          <div className="group relative bg-white border border-outline-variant rounded-lg overflow-hidden flex flex-col h-[500px]">
            <div className="relative h-2/3 overflow-hidden">
              <div
                className="w-full h-full bg-cover bg-center transition-transform duration-700 group-hover:scale-105"
                data-alt="A stunning professional photograph of a baseball game in the LVBP (Venezuelan Professional Baseball League). A batter is captured at the precise moment of contact with the ball, with dirt kicking up from the home plate and the night sky illuminated by powerful stadium lights. The focus is sharp on the action, with a shallow depth of field blurring the spectators in the background. The aesthetic is clean and authoritative."
                style={{
                  backgroundImage:
